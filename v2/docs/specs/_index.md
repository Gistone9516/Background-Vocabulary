...
| [C4-데스크톱.md](C4-데스크톱.md) | C4 | Tauri v2 셸·데스크톱 인증·오프라인 캐시·고유 기능 3종·패키징/서명/업데이터 | 상위 스펙 확정(D-1~D-11, 11건). 슬라이스 S1~S5 계획됨, 구현 착수 전. 툴체인(Rust 1.97.1 + MSVC 14.44 + Win SDK 26100) 설치·링크 실측 완료 |
